...
table{font-family: Calibri; color:white; font-size: 11pt; font-style: normal;width: 50%; background-color: SlateBlue; border-collapse: collapse; border: 2px solid navy}
